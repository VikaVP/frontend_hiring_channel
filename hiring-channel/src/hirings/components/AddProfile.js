...
class AddProfile extends React.Component {
  ...
  render() {
    return (
      <>
        <MDBContainer style={{ backgroundColor: "rgba(100,0,0,.1)", boxShadow: "10px 10px 10px rgba(0,0,0,.5)" }}>
          <p className='h4 text-center' style={{ marginTop: "100px" }}>Complete your Profile</p>
          <form onSubmit={this.addData} style={{ width: "100%" }}>
            <MDBRow>
              <MDBCol md='6' className="justify-content-end " style={{ display: "grid" }}>
              ...
              <MDBCol md='6' className="justify-content-start" style={{ display: "grid" }}>
