...
class CompanyList extends React.Component {
  ...
  handleSort(value) {
    ...
    axios.get(`${process.env.REACT_APP_API_URL1}/companies/?sortBy=Name&sort=${value}`)
      .then(res => {
        this.setState({
          posts: res.data.data,
  ...
  handleLimit(value) {
    ...
    axios.get(`${process.env.REACT_APP_API_URL1}/companies/?limit=${value}`)
      .then(res => {
        this.setState({
          posts: res.data.data,
          page: res.data.pageDetail
  ...
  onSearch = e => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL1}/companies/?s=${val}`)
      .then(res => {
  ...
  componentDidMount() {
    ...
    axios.get(`${process.env.REACT_APP_API_URL1}/companies`)
      .then(res => {
        this.setState({
          posts: res.data.data,
          page: res.data.pageDetail
  ...
  render() {
    ...
    return (
      <><Navbar fixed='top' bg='light' expand='lg'>
        ...
        <Nav className="justify-content-center" style={{ marginBottom: "50px", position: "relative", alignItems: "center", zIndex: "-1" }}>
          <Pagination>
