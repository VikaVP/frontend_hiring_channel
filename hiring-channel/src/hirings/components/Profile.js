...
class Profile extends React.Component {
  ...
  delete() {
    axios
      .delete(`${process.env.REACT_APP_API_URL}/engineers/${this.props.id}`)
      .then(response => {
  ...
  componentDidMount() {
    axios
      .get(`${process.env.REACT_APP_API_URL}/engineers/${this.props.id}`)
      .then(response => {
        this.setState({
          items: response.data,
  ...
  editData(e) {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_URL}/engineers/${this.props.id}`,
        formData,
        config
      )
      .then(response => {
