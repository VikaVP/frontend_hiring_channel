...
class CompanyProfile extends React.Component {
  ...
  delete() {
    axios.delete(`${process.env.REACT_APP_API_URL1}/companies/${this.props.id}`)
      .then((response) => {
        console.log(response)
        swal("Good job!", "Company success deleted", "success")
  ...
  componentDidMount() {
    axios.get(`${process.env.REACT_APP_API_URL1}/companies/${this.props.id}`)
      .then(response => {
        this.setState({
          items: response.data,
  ...
  editData(e) {
    ...
    axios.put(`${process.env.REACT_APP_API_URL1}/companies/${this.props.id}`, formData, config)
      .then((response) => {
        console.log(response)
        swal("Good job!", "Company success edited", "success")
